  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <Link href="#home" className="flex items-center gap-3" aria-label="Maju Berkah Teknik - kembali ke beranda">
          <Image src="/images/logo.jpeg" alt="Logo Maju Berkah Teknik" width={46} height={46} className="rounded-xl border border-slate-200 object-cover" sizes="46px" />
        ...
        <a href={whatsappLink(defaultWhatsappMessage)} target="_blank" rel="noreferrer" aria-label="Hubungi Maju Berkah Teknik via WhatsApp" className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-4 py-2 text-sm font-bold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-600">
          <PhoneCall size={16} />
